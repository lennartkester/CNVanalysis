...
folder=200508_A00295_0339_AHNTYJDMXX
...
panelOfNormals='/hpc/pmc_gen/lkester/CNV_calling/reference/panelOfNormals_v2.hdf5'
...
convert ${prefixTumor}_tumor.modeled.png ${prefixNormal}_normal.modeled.png ${prefixTumor}.20200406_panCancerCNV.png ${prefixTumor}.20200421_hematoOncoCNV.png ${prefixTumor}.20200406_neuroOncoCNV.png ${prefixTumor}.CNVreport.pdf
